...
public class GreetingController {
    ...
    @SendToUser("/message")
    public ServerResponse<String> handleSubscribe() {
        System.out.println("this is the @SubscribeMapping('/marco')");
        return ServerResponse.createBySuccessMessage("I am a msg from SubscribeMapping('/macro').");
    }
    ...
    public ServerResponse<String> send() {
        simpMessageSendingOperations.convertAndSendToUser("1", "/message", ServerResponse.createBySuccessMessage("I am a msg from SubscribeMapping('/macro')."));
        return ServerResponse.createBySuccessMessage("I am a msg from SubscribeMapping('/macro').");
    }
